...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
	<div region="north" style="height: 100px;background-image: url('images/bg1.jpg')">
		<div align="left" style="width: 80%;height:100px ;float: left;padding-top: 40px;padding-left:
		 30px;" ><font color="white" size="6" >农场管理系统</font></div>
		...
		<div class="row-fluid">
			<div class="span2 bs-docs-sidebar" >
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<li><a href="dormManager?action=list"><i class="icon-chevron-right"></i>功能1</a></li>
					<li><a href="student?action=list"><i class="icon-chevron-right"></i>功能2</a></li>
					<li><a href="dormBuild?action=list"><i class="icon-chevron-right"></i>功能3</a></li>
					<li><a href="record?action=list"><i class="icon-chevron-right"></i>功能4</a></li>
					<li><a href="password?action=preChange"><i class="icon-chevron-right"></i>功能5</a></li>
					<li><a href="login.jsp"><i class="icon-chevron-right"></i>退出</a></li>
				</ul>
			</div>
					<div class="span10">
