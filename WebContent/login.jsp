...
<div class="container">
      ...
      <form name="myForm" class="form-signin" action="login" method="post" onsubmit="return checkForm()">
        ...
        <h2 class="form-signin-heading"><font color="gray">农场管理系统</font></h2>
		...
		<label class="radio inline">
			<input id="dormManager" type="radio" name="userType" value="dormManager" ${userType==2?'checked':''} /> 操作员
		</label>
		<label class="radio inline">
			<input id="student" type="radio" name="userType" value="student"  ${userType==3?'checked':''}/> 访客
		</label>
        <label class="checkbox">
          <input id="remember" name="remember" type="checkbox" value="remember-me" ${remember==1?'checked':''}>记住密码 &nbsp;&nbsp;&nbsp;&nbsp; <font id="error" color="red">${error }</font>  
        </label>
	    <div align="center">
        <button class="btn btn-success btn-large " type="submit" >   登录   </button>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  
        <button class="btn btn-large btn-default" type="button" >   重置   </button>
		</div>

		<p align="center" style="padding-top: 15px;">Copyright © 2018  南京邮电大学  <a href="http://www.njupt.edu.cn/" target="_blank">http://www.njupt.edu.cn/</a></p>
      </form>
</div>
</body>
</html>